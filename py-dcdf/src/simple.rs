...
#[pyclass]
pub struct PyFractionSuggesterF32 {
...
#[pyfunction]
pub fn load(py: Python, file: PyObject) -> PyResult<PyObject> {
...
#[pyfunction]
pub fn load_from(py: Python, path: &str) -> PyResult<PyObject> {
    let path = Path::new(path);
